...
export default function NedsLogo() {
  return (
    <View>
      <Svg width="77" height="27" viewBox="0 0 612 215.7" fill="none">
        <G>
          <G>
            <Path
              fill="#FFFFFF"
              d="M141.2,208.5h-20.9c-6,0-10.8-1.9-14.6-5.7c-3.8-3.8-5.7-8.6-5.7-14.6v-81c0-9.5-2.9-16.5-8.6-20.9
            ...
            <Path
              fill="#FFFFFF"
              d="M265.6,159.6h29.8c-4.4,16.7-12.7,29.4-25,38.1c-12.3,9.1-27.8,13.7-46.5,13.7c-22.6,0-40.3-7.3-53-22
            ...
            <Path
              fill="#FFFFFF"
              d="M416.8,2.9h20.3c5.6,0,10.3,2.1,14.3,6.3s6,8.8,6,14v116.2c0,28.2-8.1,47.3-24.4,57.2s-34,14.9-53,14.9
            ...
            <Path
              fill="#FFFFFF"
              d="M597.9,129.2c-8-6.8-22-12.7-42.3-17.9c-1.5-0.3-8.4-1.7-11.3-2.4c-20.7-4.4-31-9.7-31-16.1
